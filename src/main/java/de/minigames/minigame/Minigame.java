 ...
 *
 */
final class Minigame implements MinigameProvider
{
    
    @Override
    public LocalizedMessageInterface getShortDescription()
    {
        return OitcMessages.ShortDescription;
    }
    
    @Override
    public String getName()
    {
        return "OneInTheChamber"; //$NON-NLS-1$
    }
    
    @Override
    public LocalizedMessageInterface getManual()
    {
        return OitcMessages.Manual;
    }
    
    @Override
    public LocalizedMessageInterface getDisplayName()
    {
        return OitcMessages.DisplayName;
    }
